...
Use this file only when the user explicitly asks to change this Skill or the `zotero_mcp.word_citations` package. Ordinary DOI/PMID conversion runs do not run pytest, Ruff, or a full project suite.
