...
def main() -> int:
    ...
    parser.add_argument("--file-type", choices=("CEL", "IDAT"), default="CEL")
    ...
    for row in rows:
        ...
        directory = published_raw_dir(root, gsm, args.file_type, retain)
    ...
    print(f"SUPPLEMENT files={sum(len(items) for items in by_gsm.values())} type={args.file_type}")
    return 0
